    ...
    <div className="p-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        <input
          ...
          className="border border-gray-300 rounded px-3 py-2 w-full sm:w-1/2 focus:outline-none focus:border-emerald-500"
        />
        <select
          value={region}
          ...
          {filteredCountries.map((country: any) => (
            ...
            >
              <Link
                ...
                className="text-emerald-600 hover:underline text-lg font-semibold"
              >
                {country.name.common}
              </Link>
