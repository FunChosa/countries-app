          ...
          <div className="w-full md:w-1/2 md:px-3">
            <div className="space-y-6 sm:max-w-md lg:max-w-lg">
              <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl">
                ...
                <span className="block xl:inline text-emerald-600">
                  {" "}
                  Real Time Data
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row sm:space-x-4">
                <Link
                  to="/countries"
                  className="flex items-center justify-center px-6 py-3 text-lg text-white bg-emerald-600 rounded-md hover:bg-emerald-700"
                >
                  Explore Now
                  <svg
